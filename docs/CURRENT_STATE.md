...
当前迁移边界：
1. 保留菜单，当前显示顺序为：/set_s、/status、/account_detail、/view_history、/pending_orders、/rebate_report、/trade、/edit_symbols、/open、/close、/stop_market、/set_current_account。
