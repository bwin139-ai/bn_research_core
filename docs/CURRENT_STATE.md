...
28. 2026-06-17 Snapback / Spring / Sweep-Reclaim 三套 live 策略开仓金额下调：`chen912` 从 `10000U` 调整为 `7500U`，`junjie2026` 从 `833U` 调整为 `650U`。Snapback 修改 `entry_notional_usdt`，Spring 与 Sweep-Reclaim 修改 `base_order_notional_usdt`；`stark21` smoke 参数保持不变。
