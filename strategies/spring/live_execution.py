...
def build_spring_live_execution_intent(
    ...
    *,
    ...
    payload = {
        ...
        "current_price": _require_signal_field(signal, "current_price"),
        "position_notional_usdt": _require_signal_field(signal, "position_notional_usdt"),
        "sl_price": _require_signal_field(signal, "sl_price"),
        "tp_price": _require_signal_field(signal, "tp_price"),
